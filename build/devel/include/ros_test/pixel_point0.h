// Generated by gencpp from file ros_test/pixel_point0.msg
// DO NOT EDIT!


#ifndef ROS_TEST_MESSAGE_PIXEL_POINT0_H
#define ROS_TEST_MESSAGE_PIXEL_POINT0_H
...
struct pixel_point0_
{
  ...
  typedef boost::shared_ptr< ::ros_test::pixel_point0_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ros_test::pixel_point0_<ContainerAllocator> const> ConstPtr;

}; // struct pixel_point0_

typedef ::ros_test::pixel_point0_<std::allocator<void> > pixel_point0;

typedef boost::shared_ptr< ::ros_test::pixel_point0 > pixel_point0Ptr;
typedef boost::shared_ptr< ::ros_test::pixel_point0 const> pixel_point0ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ros_test::pixel_point0_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ros_test::pixel_point0_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'std_msgs': ['/opt/ros/melodic/share/std_msgs/cmake/../msg'], 'ros_test': ['/home/student/myros/src/ros_test/msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ros_test::pixel_point0_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_test::pixel_point0_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_test::pixel_point0_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_test::pixel_point0_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_test::pixel_point0_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_test::pixel_point0_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ros_test::pixel_point0_<ContainerAllocator> >
{
  static const char* value()
  {
    return "568de94a5e690be17be9fc43dbdabde8";
  }

  static const char* value(const ::ros_test::pixel_point0_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x568de94a5e690be1ULL;
  static const uint64_t static_value2 = 0x7be9fc43dbdabde8ULL;
};

template<class ContainerAllocator>
struct DataType< ::ros_test::pixel_point0_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ros_test/pixel_point0";
  }
...
template<class ContainerAllocator>
struct Definition< ::ros_test::pixel_point0_<ContainerAllocator> >
{
  static const char* value()
  {
    return "string name\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ros_test::pixel_point0_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ros_test::pixel_point0_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_test::pixel_point0_<ContainerAllocator>& v)
  {
    s << indent << "name: ";
...
#endif // ROS_TEST_MESSAGE_PIXEL_POINT0_H
