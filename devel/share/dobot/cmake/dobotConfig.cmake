...
if("TRUE" STREQUAL "TRUE")
  set(dobot_SOURCE_PREFIX /home/student/myros/src/dobot)
  set(dobot_DEVEL_PREFIX /home/student/myros/devel)
  set(dobot_INSTALL_PREFIX "")
  set(dobot_PREFIX ${dobot_DEVEL_PREFIX})
else()
  set(dobot_SOURCE_PREFIX "")
  set(dobot_DEVEL_PREFIX "")
  set(dobot_INSTALL_PREFIX /home/student/myros/install)
...
if(NOT "/home/student/myros/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dobot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/myros/src/dobot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT dobot_NUM_DUMMY_TARGETS)
      set(dobot_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::dobot::wrapped-linker-option${dobot_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR dobot_NUM_DUMMY_TARGETS "${dobot_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::dobot::wrapped-linker-option${dobot_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND dobot_LIBRARIES "${interface_target_name}")
